  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .heart {
        ...
        opacity: 0.7;
        pointer-events: none; /* Kalpler tıklamayı engellemesin */
        z-index: 0;
      }
    `;
    ...
    <div style={styles.container}>
      ...
      {!answered ? (
        <>
          ...
          <img
            src="/eca9ab39-c3c5-48ab-b7b1-2f558e382815.png"
            alt="Zor Soru"
            style={styles.image}
          />
        ...
        <div style={styles.response}>
          <h3>İnanılmazsın! 🔥</h3>
          <p>
            Bu zor soruyu bile çözdün ya. Sana hayran olmamak elde değil. <br />
            Kalbin kadar aklın da muhteşem şimom, benim zeki şimom 💖
          </p>
